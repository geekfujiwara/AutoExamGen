...
作成した研修プログラムをISO3166で規定する様々な言語(50か国語)に翻訳することができます。
...
研修プログラムが作成できたら、研修プログラムを関係する組織に割り当てして研修を受けさせるようにします。

現在このアプリでは、代表的な以下の言語にラベル上対応しています。必要のに応じてラベル言語を追加するようにしてください。
